            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row"><img src="<?= asset() ?>/images/avatars/profile-image-1.png" alt="">Anna Doe</th>
                                <td>Modern</td>
                                <td>#53327</td>
                                <td>$20</td>
                            ...
                            <tr>
                                <th scope="row"><img src="<?= asset() ?>/images/avatars/profile-image-2.png" alt="">John Doe</th>
                                <td>Alpha</td>
                                <td>#13328</td>
                                <td>$25</td>
                            ...
                            <tr>
                                <th scope="row"><img src="<?= asset() ?>/images/avatars/profile-image.png" alt="">John Doe</th>
                                <td>Circl Admin</td>
                                <td>#73423</td>
                                <td>$23</td>
                            ...
                            <tr>
                                <th scope="row"><img src="<?= asset() ?>/images/avatars/profile-image-1.png" alt="">Nina Doe</th>
                                <td>Space</td>
                                <td>#54773</td>
                                <td>$20</td>
                                <td><span class="badge bg-success">Paid</span></td>
...
<div class="row">
    ...
    <div class="col-md-12 col-lg-4">
        <div class="card">
            <img src="<?= asset() ?>/images/card-bg.jpg" class="card-img-top" alt="...">
            <div class="card-body">
